...
type java_lang_Object struct {
	...
	methods    func() map[string]interface{} // maps names to their method implementation
}
...
func (arg0 *java_lang_Object) callMethod(methodName string, params ...interface{}) interface{} {
	...
	if m == nil {
		panic(fmt.Sprintf("abstract method %s on %s has no implementation", methodName, arg0.name))
	}
